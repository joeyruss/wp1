...
<div class="upgrade-promo <?php if(!empty($hideBug)): ?> hide-on-mobile <?php endif; ?>">
    <div class="upgrade-interior">
        ...
        <ul>
            <li>Migrate your existing WordPress media library to <?php echo e(\ILAB\MediaCloud\Storage\StorageToolSettings::currentDriverName()); ?></li>
            ...
            <li>Upload directly to <?php echo e(\ILAB\MediaCloud\Storage\StorageToolSettings::currentDriverName()); ?> (Pro)</li>
            <li>Built-in <?php echo e(\ILAB\MediaCloud\Storage\StorageToolSettings::currentDriverName()); ?> storage browser (Pro)</li>
            <li>Import media from <?php echo e(\ILAB\MediaCloud\Storage\StorageToolSettings::currentDriverName()); ?> (Pro)</li>
